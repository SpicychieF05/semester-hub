...
const HomePage = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <section
                ref={vantaRef}
                className={`text-white relative overflow-hidden min-h-[600px] flex items-center transition-all duration-800 ease-theme ${isDarkMode
                    ? 'bg-dark-primary'
                    : 'bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800'
                    }`}
            >
                {/* Animated background pattern - only show in light mode */}
                {!isDarkMode && (
                    <>
                        ...
                        {/* Background glow effects - only show in light mode */}
                ...
                <div className="container-responsive py-8 sm:py-12 lg:py-16 relative z-20">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        <div className="text-center lg:text-left">
                            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 sm:mb-6 transition-all duration-800">
                                Your Premier Platform for
                                <span className={`block transition-all duration-800 ${isDarkMode ? 'text-accent-blue' : 'text-primary-200'}`}>
                                    Academic Excellence
                                </span>
                            </h1>
                            <p className={`text-lg sm:text-xl mb-6 sm:mb-8 leading-relaxed px-4 lg:px-0 transition-all duration-800 ${isDarkMode
                                ? 'text-text-secondary'
                                : 'text-primary-100'
                                }`}>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 px-4 lg:px-0">
                                ...
                                >
                                    <span className={`transition-all duration-300 ${isDarkMode
                        ...
                        {/* Hero Image - Only visible in light theme */}
                        {!isDarkMode && (
            ...
            {/* Features Section */}
            <section className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-dark-primary transition-colors duration-300">
                <div className="container-responsive">
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-secondary-900 dark:text-text-primary mb-2 sm:mb-4 px-4">
                            Why Choose Semester Hub?
                        </h2>
                        <p className="text-lg sm:text-xl text-secondary-600 dark:text-text-secondary max-w-3xl mx-auto px-4">
                            Empowering students with the tools and resources they need to succeed academically
                        </p>
                    </div>

                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-0">
                        <div className="card hover:shadow-lg transition-shadow duration-300 dark:bg-dark-secondary dark:border-border-subtle">
                            <div className="text-primary-600 dark:text-accent-blue mb-4">
                                <BookOpen size={40} className="sm:w-12 sm:h-12" />
                            </div>
                            <h3 className="text-lg sm:text-xl font-semibold text-secondary-900 dark:text-text-primary mb-3">
                                Quality Notes
                            </h3>
                            <p className="text-sm sm:text-base text-secondary-600 dark:text-text-secondary">
            ...
            {/* Stats Section */}
            <section className="py-12 sm:py-16 lg:py-20 bg-secondary-50 dark:bg-dark-secondary transition-colors duration-300">
                <div className="container-responsive">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center">
                        ...
                        <div className="px-2">
                            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600 dark:text-accent-blue mb-1 sm:mb-2">5K+</div>
                            <div className="text-sm sm:text-base text-secondary-600 dark:text-text-secondary font-medium">Notes Shared</div>
                        </div>
                        <div className="px-2">
                            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600 dark:text-accent-blue mb-1 sm:mb-2">100+</div>
                            <div className="text-sm sm:text-base text-secondary-600 dark:text-text-secondary font-medium">Subjects</div>
                        </div>
                        <div className="px-2">
                            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary-600 dark:text-accent-blue mb-1 sm:mb-2">95%</div>
                            <div className="text-sm sm:text-base text-secondary-600 dark:text-text-secondary font-medium">Success Rate</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-primary-600 to-primary-700 text-white">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
                        ...
                        >
                            <span className="text-primary-700 dark:text-text-neon-white">Get Started Today</span>
                        </Link>
                        <Link
                            to="/browse"
